...
const navLinks = [
  ...
  { label: "AutoEval", to: "/autoeval/about" },
  ...
  return (
    <>
      ...
      <div className={mobileWrapperClassName}>
        <div
          className="fixed top-0 left-0 right-0 z-50 w-full flex items-center justify-between bg-[rgba(24,29,54,0.95)] backdrop-blur-md px-6 py-3 border-b-[3px] border-b-[#59A2FF]/80 sm:border-b-[#005BCD]/80 shadow-[0_2px_20px_rgba(0,46,103,0.45)]"
        >
