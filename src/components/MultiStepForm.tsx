    ...
    return (
        <div className={`h-full flex flex-col overflow-hidden ${className}`}>
            <div className="flex w-full h-full">
                ...
                <div
                    className={`h-full p-6 flex flex-col overflow-hidden relative transition-all duration-700 ease-in-out ${isStep6Transition || !shouldShowRightPanel ? 'w-full' : 'w-2/3'
                        }`}
                >
                    {/* Breadcrumb */}
            ...
            <div className="mb-4 p-4 bg-gradient-to-r from-slate-800 to-slate-900 border border-slate-700 rounded-lg shadow-lg">
              <div className="flex items-center justify-between">
                                    ...
                                    {isLastStep ? (
                                        ...
                                        <div className="flex gap-2">
                                            <Button
                                                ...
                                                className={`border border-slate-400 text-white hover:bg-blue-600 hover:border-blue-600 px-4 py-2 text-sm transition-colors duration-200 ${isFirstStep ? 'opacity-50 cursor-not-allowed' : ''
                                                    }`}
                                                size="sm"
                                                variant="outline"
                                            >
                                            ...
                                            <Button
                                                onClick={handleNext}
                                                disabled={isLastStep}
                                                className={`border border-slate-400 text-white hover:bg-blue-600 hover:border-blue-600 px-4 py-2 text-sm transition-colors duration-200 ${isLastStep ? 'opacity-50 cursor-not-allowed' : ''
                                                    }`}
                                                size="sm"
                                                variant="outline"
                                            >
                ...
                {shouldShowRightPanel && (
                    <div
                        className={`h-full p-6 overflow-hidden transition-all duration-700 ease-in-out ${isStep6Transition
